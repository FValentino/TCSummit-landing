import { MapPin, Users, Globe, UserCheck, Lightbulb, Palette, Building, Mic, Store, Tv } from 'lucide-react'
...
{ id: 1, year: "2023", description: "1. Nace TechnoCrypto Summit", icon: Lightbulb, status: "completed" },
  ...
  { id: 10, year: "En ejecución", description: "10. Stands en instituciones, shopping y sponsors", icon: Store, status: "current" },
  { id: 11, year: "En ejecución", description: "11. Programa de TV y Redes", icon: Tv, status: "current" },
  { id: 12, year: "En ejecución", description: "12. Conexiones para desarrollar evento en Uruguay y Chile", icon: Globe, status: "current" }  
